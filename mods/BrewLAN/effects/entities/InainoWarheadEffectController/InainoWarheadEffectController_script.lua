------------------------------------------------------------------------------------------------------
-- File     :  FAF versino of \effects\Entities\InainoEffectController01\InainoBombEffectController01_script.lua
...
InainoEffectController = Class(NullShell) {    
...
TypeClass = InainoEffectController