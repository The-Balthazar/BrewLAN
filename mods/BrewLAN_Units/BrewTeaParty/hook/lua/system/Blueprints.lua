...
function BrewLANPersonalShieldCategory(all_bps)
    for id, bp in all_bps do
        if bp.Categories and bp.Defense and bp.Defense.Shield then
            if (bp.Defense.Shield.PersonalShield or bp.Defense.Shield.ShieldSize < math.max(bp.SizeX or 1, bp.SizeY or 1, bp.SizeZ or 1) + 3) and table.find(bp.Categories, 'SHIELD') then
