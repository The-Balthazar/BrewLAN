...
local TShieldLandUnit = import('/mods/BrewLAN_Gamemodes/TeaD/lua/CreepScript.lua').Creep --import('/lua/terranunits.lua').TShieldLandUnit

TEC0005 = Class(TShieldLandUnit) {
