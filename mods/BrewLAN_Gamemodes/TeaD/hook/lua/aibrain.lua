...
--------------------------------------------------------------------------------
--  AIOnlyTeam Check: Checks if a player is an AI on an AI only team.
--------------------------------------------------------------------------------
    AIOnlyTeam = function(self, strArmy)
        ...
        if
          ...
          self.BrainType != 'Human' and ScenarioInfo.ArmySetup[strArmy].Team > 1 then
            ...
            --LOG(repr(ScenarioInfo.ArmySetup[strArmy]))        
        end
        if ScenarioInfo.TeamGame == true or ScenarioInfo.Options.TeamLock == 'locked' then
            TeamGame = true                        
        end
        --if AiTeam and TeamGame then
        --    LOG("THIS FUCKER IS HUMANLESS " .. ScenarioInfo.ArmySetup[strArmy].PlayerName )        
        --end
