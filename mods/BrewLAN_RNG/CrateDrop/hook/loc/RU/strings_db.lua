...
CrateDrop_LOB_Hats_falseD="Шляпы выпадают из ящиков с нормальной вероятностью."
CrateDrop_LOB_Hats_true="Включено"
CrateDrop_LOB_Hats_trueT="Режим \"только шляпы\" включен"
CrateDrop_LOB_Hats_trueD="Шляпы выпадают из ящиков со стопроцентной вероятностью."
