...
if not (string.sub(GetVersion(),1,3) == '1.1' or string.sub(GetVersion(),1,3) == '1.0') then
    nameFilters = import('/lua/ui/dialogs/createunitfilters.lua').Filters
else
    nameFilters = import('/mods/brewlan_gameplay/stolentech/hook/lua/ui/dialogs/createunitfilters.lua').Filters
end
